...
declare module '$env/static/private' {
	...
	export const PROGUARD_HOME: string;
	...
	export const WOODPECKER_SERVER: string;
	export const WOODPECKER_TOKEN: string;
}
